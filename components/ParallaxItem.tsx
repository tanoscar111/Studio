...
const ParallaxItem = (props:any) => {  
  ...
  return (
    ...
    <div className="content__item relative w-auto my-20">
      <span className="content__item-number absolute text-[200px] top-28 right-20 opacity-30">
        {props.no}
      </span>
      
      <div className="relative overflow-hidden w-full h-[500px]">
        <div className="content__item-img absolute w-full h-[500px] bg-cover bg-center opacity-80"
