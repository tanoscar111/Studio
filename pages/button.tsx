...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className='bg-gray-900 text-white flex justify-center items-center h-[100vh]'>
        <div className='text-white flex justify-center items-center relative'>
          <img src='img/mask.png' style={{height:'100%'}} className="absolute top-0 left-[27px] z-10"/>
          <button className="animation-button border-2 border-gray-700 mx-10">
