...
var DOM = {
  content: {
    home: {
      section: document.querySelector('.fluid__item--home'),
    ...
    about: {
      section: document.querySelector('.fluid__item--about'),
...
.addLabel('switchtime').add(function () {
  DOM.content.home.section.classList.toggle('fluid__item--current');
  DOM.content.about.section.classList.toggle('fluid__item--current');
